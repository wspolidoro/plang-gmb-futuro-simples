...
export function RevenueProjection({ businessData, additionalImpact = 0, setCalculatedData }: RevenueProjectionProps) {
  ...
  const projectionsTreatment = () => {
    ...
    //setData({ nome: 'Kledisom', idade: 30, currentRevenue: currentRevenue, projections: arr });
    setCalculatedData({businessData , currentRevenue: currentRevenue, projections: arr });
    //console.log("Dados do negócio:", data);
  }

  useEffect(() => {
    projectionsTreatment();
  }, [])

  // console.log(calculateProjection)
